...
namespace CommonGateway\GatewayTestBundle\Service;
...
class InstallationService implements InstallerInterface
{
    ...
    {
        $this->logger->debug("GatewayTestBundle -> Install()");
    ...
    {
        $this->logger->debug("GatewayTestBundle -> Update()");
    ...
    {
        $this->logger->debug("GatewayTestBundle -> Uninstall()");
